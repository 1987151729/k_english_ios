...
class BlogTableViewCell: UITableViewCell {
    ...
    var uImgCheck: UIImageView!
    var uImgComment: UIImageView!
    var uImgLike: UIImageView!
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        if !self.isEqual(nil) {
            // 内含cell高度自适应的诀窍！
            let uViewItemBox = UIView()
            let uImgBackground = UIImageView(image: UIImage(named:"icon_rectangle_bg"))
